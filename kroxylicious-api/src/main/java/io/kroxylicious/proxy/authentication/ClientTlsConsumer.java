...
/**
 * <p>Annotation to be applied to {@link io.kroxylicious.proxy.filter.FilterFactory FilterFactories} that
 * create filters that are {@link ClientConnectionAware}.</p>
 *
...
public @interface ClientTlsConsumer {
