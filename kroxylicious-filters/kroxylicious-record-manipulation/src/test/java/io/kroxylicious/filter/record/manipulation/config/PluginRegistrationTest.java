...
import io.kroxylicious.filter.record.manipulation.ops.choose.ChooseDouble;
import io.kroxylicious.filter.record.manipulation.ops.choose.ChooseFloat;
import io.kroxylicious.filter.record.manipulation.ops.choose.ChooseInt;
import io.kroxylicious.filter.record.manipulation.ops.choose.ChooseLong;
import io.kroxylicious.filter.record.manipulation.ops.choose.ChooseString;
import io.kroxylicious.filter.record.manipulation.ops.constant.ValueBigInteger;
import io.kroxylicious.filter.record.manipulation.ops.constant.ValueBoolean;
import io.kroxylicious.filter.record.manipulation.ops.constant.ValueBytes;
import io.kroxylicious.filter.record.manipulation.ops.constant.ValueDouble;
import io.kroxylicious.filter.record.manipulation.ops.constant.ValueFloat;
import io.kroxylicious.filter.record.manipulation.ops.constant.ValueInt;
import io.kroxylicious.filter.record.manipulation.ops.constant.ValueLong;
import io.kroxylicious.filter.record.manipulation.ops.constant.ValueString;
import io.kroxylicious.filter.record.manipulation.ops.encryption.DecryptString;
import io.kroxylicious.filter.record.manipulation.ops.encryption.EncryptString;
import io.kroxylicious.filter.record.manipulation.ops.random.RandomBoolean;
import io.kroxylicious.filter.record.manipulation.ops.random.RandomBytes;
import io.kroxylicious.filter.record.manipulation.ops.random.RandomDouble;
import io.kroxylicious.filter.record.manipulation.ops.random.RandomFloat;
import io.kroxylicious.filter.record.manipulation.ops.random.RandomInt;
import io.kroxylicious.filter.record.manipulation.ops.random.RandomLong;
import io.kroxylicious.filter.record.manipulation.ops.random.RandomString;
