...
public class AvroJsonFormat implements DataFormat<GenericRecord> {
    private final Schema schema;

    public AvroJsonFormat(Schema schema) {
        this.schema = schema;
    }

    @Override
    public Serializer<GenericRecord> serializer() {
        return new AvroJsonSerializer(schema);
    }

    @Override
    public Deserializer<GenericRecord> deserializer() {
        return new AvroJsonDeserializer(schema);
    }
}
