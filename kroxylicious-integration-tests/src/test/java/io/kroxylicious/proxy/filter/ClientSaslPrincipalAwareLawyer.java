...
//@ClientPrincipalConsumer(SaslPrincipal.class)
@Plugin(configType = Void.class)
public class ClientSaslPrincipalAwareLawyer implements FilterFactory<Void, Void> {
    ...
    public Filter createFilter(FilterFactoryContext context, Void initializationData) {
        return new ClientSaslPrincipalAwareLawyerFilter();
    }
}
