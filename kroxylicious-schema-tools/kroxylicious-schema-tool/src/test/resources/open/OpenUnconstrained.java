...
/**
 * Auto-generated class representing the schema at /properties/unconstrained.
 */
@javax.annotation.processing.Generated("io.kroxylicious.tools.schema.compiler.CodeGen")
@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(using = com.fasterxml.jackson.databind.JsonDeserializer.None.class)
public class OpenUnconstrained {
    ...
    public java.lang.String toString() {
        return "OpenUnconstrained[" + this.unknownProperties + "]";
    }
    ...
    public boolean equals(java.lang.Object other) {
        if (this == other)
            return true;
        else if (other instanceof open.OpenUnconstrained otherOpenUnconstrained)
            return java.util.Objects.equals(this.unknownProperties, otherOpenUnconstrained.unknownProperties);
        else
            return false;
    }
}