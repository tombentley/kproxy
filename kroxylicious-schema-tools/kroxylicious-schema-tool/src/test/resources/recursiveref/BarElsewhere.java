...
public class BarElsewhere {
    ...
    public BarElsewhere(@edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "foo") recursiveref.Foo foo) {
        this.foo = foo;
    }
    ...
    public java.lang.String toString() {
        return "BarElsewhere[" + "foo: " + this.foo + this.unknownProperties + "]";
    }
    ...
    public boolean equals(java.lang.Object other) {
        if (this == other)
            return true;
        else if (other instanceof recursiveref.BarElsewhere otherBarElsewhere)
            return java.util.Objects.equals(this.foo, otherBarElsewhere.foo) && java.util.Objects.equals(this.unknownProperties, otherBarElsewhere.unknownProperties);
        else
            return false;
    }
}