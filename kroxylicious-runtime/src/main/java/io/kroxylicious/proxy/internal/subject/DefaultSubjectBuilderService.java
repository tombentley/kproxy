...
@Plugin(configType = DefaultSubjectBuilderService.Config.class)
public class DefaultSubjectBuilderService implements TransportSubjectBuilderService<DefaultSubjectBuilderService.Config>,
        SaslSubjectBuilderService<DefaultSubjectBuilderService.Config> {
    ...
    @Override
    public TransportSubjectBuilder buildTransportSubjectBuilderService() {
        return new DefaultSubjectBuilder(adders);
    }

    @Override
    public SaslSubjectBuilder buildSaslSubjectBuilderService() {
        return new DefaultSubjectBuilder(adders);
    }
